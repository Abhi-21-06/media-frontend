  ...
  return (
    ...
    {/* head */}
      ...
      <Row className="mt-5 align-items-center justify-content-between w-100">
        <Col></Col>
        <Col lg={5}>
        <h1 style={{color:"white",fontSize:"40px"}}>Welcome to <span className='text-warning'>Play yok</span>
        </h1>
        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nisi voluptatem nobis aut 
          laudantium quia vitae aperiam obcaecati. Exercitationem amet, enim, quibusdam dolore magnam distinctio 
          reprehenderit odio est voluptates, dolorum sit.</p>
    ...
    {/* Cards */}
      ...
      <div className="container border d-flex align-items-center justify-content-center mt-5 p-4">
        ...
        <iframe width="560" height="315" src="https://www.youtube.com/embed/Kg-0Wwarl7w?si=lZHw5SgadAlb1l7f" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowFullscreen></iframe>
        </div>
      </div>
